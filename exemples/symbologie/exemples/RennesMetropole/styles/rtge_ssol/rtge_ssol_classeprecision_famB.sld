...
<!--
  ...
  nom du SLD : rtge_ssol_classeprecision_famB

  couche source dans la base :  topossol.ef_troncon
  layer cible du style       :  ref_topo:ef_troncon

  objet :  Style relatif aux classes de précisions des objets de sous-sol de la famille B.
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>rtge_ssol_classeprecision_famB</se:Name>
      <se:Description>
        <se:Title>Classes de précision des réseaux du sous sol de la famille B</se:Title>
        <se:Abstract>Style de la famille B - Bâtiment</se:Abstract>
      </se:Description>
