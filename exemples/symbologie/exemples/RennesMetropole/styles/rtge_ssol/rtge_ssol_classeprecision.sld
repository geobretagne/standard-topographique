...
<!--
  ...
  nom du SLD : rtge_ssol_classeprecision

  couche source dans la base :  topossol.ef_troncon
  layer cible du style       :  ref_topo:ef_troncon

  objet :  Style relatif aux classes de précisions des objets de sous-sol.
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>rtge_ssol_classeprecision</se:Name>
      <se:Description>
        <se:Title>Classes de précision des réseaux du sous sol</se:Title>
        <se:Abstract>Style Classes de précision des réseaux du sous sol</se:Abstract>
      </se:Description>
