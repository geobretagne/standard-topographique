...
<!--
  ...
  nom du SLD : rtge_ssol_classeprecision_famA

  couche source dans la base :  topossol.ef_troncon
  layer cible du style       :  ref_topo:ef_troncon

  objet :  Style relatif aux classes de précisions des objets de sous-sol de la famille A.
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>rtge_ssol_classeprecision_famA</se:Name>
      <se:Description>
        <se:Title>Classes de précision des réseaux du sous sol de la famille A</se:Title>
        <se:Abstract>Style de la famille A - Eau Potable</se:Abstract>
      </se:Description>
