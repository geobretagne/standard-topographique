...
<!--
  ...
  nom du SLD : rtge_ssol_indetermine

  couche source dans la base :  topossol.v_indef_mat
  layer cible du style       :  ref_topo:rtge_ssol_indetermine
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>ref_topo:rtge_ssol_indetermine</se:Name>
    <UserStyle>
      <se:Name>rtge_ssol_indetermine</se:Name>
      <se:Description>
        <se:Title>Indéterminé de sous-sol</se:Title>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Indéterminé - Réseaux abandonnées</se:Name>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Sous sol - Indéterminé - Chambre de forme complexe </se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Sous-sol - Indéterminé - Caniveau de galerie technique </se:Name>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Sous-sol - Indéterminé - Conduite </se:Name>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Sous-sol - Indéterminé - Nappe de fourreau </se:Name>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Sous-sol - Indéterminé - Nappe de câble </se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Sous-sol - Indéterminé - Chambre multi-réseaux </se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
