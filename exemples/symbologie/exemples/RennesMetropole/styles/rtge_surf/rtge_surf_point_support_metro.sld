...
<!--
  ...
  nom du SLD : rtge_surf_point_support_metro

  couche source dans la base :  toposurf.point_support
  layer cible du style       :  ref_topo:rtge_surf_point_support
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>ref_topo:rtge_surf_point_support</se:Name>
    <UserStyle>
      <se:Name>rtge_surf_point_support_metro</se:Name>
      <se:Description>
