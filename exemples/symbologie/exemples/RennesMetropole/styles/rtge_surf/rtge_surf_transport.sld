...
<!--
  ...
  nom du SLD : rtge_surf_transport

  couche source dans la base :  toposurf.v_trans_mat
  layer cible du style       :  ref_topo:rtge_surf_transport
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>ref_topo:rtge_surf_transport</se:Name>
    <UserStyle>
      <se:Name>rtge_surf_transport</se:Name>
      <se:Description>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Tablier viaduc passerelle</se:Name>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Ouvrage annexe</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Trappe rectangulaire métro</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Trappe carré métro</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Aération rectangulaire métro</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Aération carrée métro</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Poteau d'arrêt de bus</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Distributeur de tickets</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>RTGE Surface - Transport - Abri bus</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>modele</ogc:PropertyName>
